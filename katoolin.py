...
0) Install all Information Gathering tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("dnf install cookie-cadger")
							elif opcion2 == "11":
								...
								cmd = os.system("dnf install nmap")
							elif opcion2 == "36":
